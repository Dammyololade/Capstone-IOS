...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
        ...
        for i in 0..<10 {
            ...
            dish.category = "Buggers"
            dish.title = "Dish \(i)"
            dish.price = "23.90"
            dish.descriptionInfo = "Lorem ipsum Ifat hugh shdte soidusbdsbdbshe sbvewbec sdbclsbhdcbyager wlevfchwbedchvbw cwvoc lwhvcwcw cwc wcbvlw cedhvwoevwvehwvww"
